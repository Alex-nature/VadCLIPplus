...
if __name__ == '__main__':
    ...
    # visual_head/visual_layers/attn_window are no longer CLI options (TCA used instead);
    # pass safe defaults here to match constructor signature
    ...
    try:
        ...
        # ensure logging is stopped and flushed
        stop_logging()